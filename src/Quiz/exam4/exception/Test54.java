...
// ...instances of Exception classes are used, so [Line 10] compiles successfully.

// No issues with [Line 16] as method getReport() declares to throw SQLException and...
// ...main(String []) method code correctly handles it.

// Program compiles successfully but on execution, [NullPointerException is thrown],...
// ...stack trace is printed on to the console and program ends abruptly.
